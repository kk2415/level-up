...
import com.levelup.api.controller.v1.dto.request.channelPost.ChannelPostRequest;
import com.levelup.api.controller.v1.dto.response.channelPost.ChannelPostResponse;
...
public class ChannelPostApiController {
    ...
    public ResponseEntity<Page<ChannelPostResponse>> getChannelPosts(
            @RequestParam("channel") Long channelId,
            ...
            @RequestParam(required = false) String query)
    {
        Page<ChannelPostResponse> response
                = channelPostService.getChannelPosts(channelId, articleType, field, query, pageable)
