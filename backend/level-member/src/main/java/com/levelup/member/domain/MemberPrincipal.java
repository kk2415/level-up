package com.levelup.member.domain;
...
public class MemberPrincipal extends User {
    ...
    public MemberPrincipal(Long id, boolean isAdmin, String username, String password, Collection<? extends GrantedAuthority> authorities) {
