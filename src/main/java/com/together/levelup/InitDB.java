...
//                    "리액트에 대한 전반적인 개념을 공부하는 스터디", "데이터베이스 기초에 대한 스터디", ChannelCategory.STUDY, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            Channel channel2 = Channel.createChannel(manager2, "스프링 기본개념", 20L,
//                    "스프링 초보들 다 모여라!", "데이터베이스 기초에 대한 스터디", ChannelCategory.STUDY, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            Channel channel3 = Channel.createChannel(manager2, "HTTP 완전 정복", 20L,
//                    "HTTP 완전 정복 가이드 책을 따라 읽는 스터디", "데이터베이스 기초에 대한 스터디", ChannelCategory.STUDY, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            Channel channel4 = Channel.createChannel(manager2, "데이터베이스 기본반", 20L,
//                    "데이터베이스 기초에 대한 스터디", "데이터베이스 기초에 대한 스터디", ChannelCategory.STUDY, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            Channel channel5 = Channel.createChannel(manager2, "자바 코테 스터디", 20L,
//                    "자바 코테 준비 스터디입니다", "데이터베이스 기초에 대한 스터디", ChannelCategory.STUDY, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            Channel channel6 = Channel.createChannel(manager2, "스프링 기반 프로젝트", 20L,
//                    "스프링 기반 프로젝트입니다", "데이터베이스 기초에 대한 스터디", ChannelCategory.PROJECT, new UploadFile("default.png", FileStore.CHANNEL_DEFAULT_IMAGE));
//            em.persist(channel1);
//            em.persist(channel2);
//            em.persist(channel3);
//            em.persist(channel4);
